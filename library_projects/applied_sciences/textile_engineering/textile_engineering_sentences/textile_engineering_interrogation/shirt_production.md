...
Mayoritas logo yang terasa tebal dan menempel menggunakan jenis sablon berbasis plastik atau lem transfer:

#### 1.1. Sablon Plastisol

Jenis tinta ini berbahan dasar minyak dan PVC yang sifatnya tidak meresap ke dalam kain, melainkan membentuk lapisan karet padat di atas permukaan kain.

#### 1.2. Sablon Polyflex

Menggunakan lembaran stiker vinil tipis yang dipotong menggunakan mesin, lalu direkatkan ke kaos menggunakan mesin press panas.
...
## A: Logo bordir adalah logo yang dibuat dengan cara menyulam benang langsung di atas permukaan kain kaos menggunakan pola tertentu. Berbeda dengan sablon yang menggunakan tinta atau stiker, logo bordir menghasilkan tekstur timbul yang terbentuk dari jalinan benang-benang jahit yang rapat. Berikut adalah karakteristik utama dari logo bordir pada pakaian:

### 1. Proses Pembuatan

Pada era modern saat ini, logo bordir tidak lagi dibuat manual dengan tangan, melainkan menggunakan Bordir Komputer (Digital Embroidery). Desain logo digital dimasukkan ke dalam program komputer, lalu mesin bordir otomatis akan menjahit pola tersebut ke kain kaos dengan presisi tinggi.

### 2. Keunggulan Logo Bordir

#### 2.1. Sangat Awet

Tidak akan retak, pecah, atau terkelupas seperti sablon tempelan meskipun sering dicuci dan disetrika.

#### 2.2. Kesan Eksklusif

Memberikan tampilan yang rapi, formal, mewah, dan profesional.

#### 2.3. Warna Tahan Lama

Benang bordir berkualitas tinggi tidak mudah pudar warnanya dibandingkan tinta cetak.

### 3. Kelemahan Logo Bordir

#### 3.1. Kaku pada Kain Tipis

Jalinan benang yang padat membuat area logo menjadi kaku. Jika dipasang pada kaos berbahan sangat tipis, kain di sekitar bordiran bisa berkerut atau tertarik.
